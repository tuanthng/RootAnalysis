...
void getOpticalFlowParameter(std::string filename, optical_flow_params_t *params)
{
	string line;
	...
	if (myfile.is_open())
	{
		...
		getline(myfile, line);
		getline(myfile, line); //#float alpha;             // smoothness weight
		params->alpha = stof(line.c_str());
		
		getline(myfile, line);
		getline(myfile, line); 
		params->beta = stof(line.c_str());

		getline(myfile, line);
		getline(myfile, line);
		params->gamma = stof(line.c_str());

		getline(myfile, line);
		getline(myfile, line);
		params->delta = stof(line.c_str());

		getline(myfile, line);
		getline(myfile, line);
		params->sigma = stof(line.c_str());

		getline(myfile, line);
		getline(myfile, line);
		params->bk = stof(line.c_str());

		getline(myfile, line);
		getline(myfile, line);
		params->eta = stof(line.c_str());

		getline(myfile, line);
		getline(myfile, line);
		params->min_size = atoi(line.c_str());

		getline(myfile, line);
		getline(myfile, line);
		params->n_inner_iteration = atoi(line.c_str());

		getline(myfile, line);
		getline(myfile, line);
		params->n_solver_iteration = atoi(line.c_str());

		getline(myfile, line);
		getline(myfile, line);
		params->sor_omega = stof(line.c_str());
